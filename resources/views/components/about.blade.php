...
<div class='w-full mx-auto lg:max-w-screen-xl  px-4'>
    <div class='flex flex-col lg:flex-row items-center lg:items-start lg:justify-berween py-16'>
        <!-- Left Column: Image -->
        <div class=' flex  flex-1 mb-8 lg:mb-0'>
            <img src="{{ asset('assets/profileimage.svg') }}" alt="About Image" class='w-64 h-auto rounded-lg shadow-lg'>
        </div>
